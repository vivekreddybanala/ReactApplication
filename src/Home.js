...
import './App.css';
import { FormControl, InputGroup, Panel } from 'react-bootstrap';
...
class Home extends Component {
    ...
    getPosts() {
        ...
        Axios.get('https://jsonplaceholder.typicode.com/todos').then(data => {
            ...
            this.setState({ name: 'Vivek Reddy Banala' })
                ...
                {this.state.posts.map(element => {
                    return (
                        <div style={{ padding: "1%" }}>
                            ...
                            <footer style={{ paddingLeft: "25%", paddingRight: "25%" }}>
                                <Button className="btn btn-primary" style={{float:"left"}}>Like</Button>
                                <InputGroup className="mb-3" style={{float:"left",width:"93%"}}>
                                    <FormControl
                                        placeholder="Comment"
                                        aria-label="Comment"
